...
/*["LeadTrack01_F",0,1] remoteExec [BIS_fnc_playMusic,-2];//Play some music that lasts a while
["<t color='#ff0000' size='2'>Defend the satellite!</t>", "PLAIN DOWN", 1, true, true] remoteExec [titleText,-2]; //Display a hint in the middle of screen (https://community.bistudio.com/wiki/titleText)
[2] remoteExec [BIS_fnc_earthquake,-2]; //earthquake
