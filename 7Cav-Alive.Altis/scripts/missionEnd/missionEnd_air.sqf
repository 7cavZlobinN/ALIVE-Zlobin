...
//group createUnit [type, position, markers, placement, special]
  _group createUnit [
    ...
    getMarkerPos "air_marker1", //position
    [], 
...
[ missionConfigFile >> "CfgORBAT" >> "air" , "mil_destroy", [1,0.1,0.1,1], 1, 1, 0, "Killed", true ] call BIS_fnc_ORBATAddGroupOverlay; sleep 5; //kll that orbat commander
